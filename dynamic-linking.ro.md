...
Pentru o folosire robustă, există alte mijloace de precizare a căilor de căutare a bibliotecilor partajate, documentate în [**manualul loader-ului/linker-ului dinamic (ld.so)**](https://man7.org/linux/man-pages/man8/ld.so.8.html#DESCRIPTION).
