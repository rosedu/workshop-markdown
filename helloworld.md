...
| :--- | :--- | :--- | :--- | :--- |
| C | [The Standard - C](https://en.cppreference.com/w/c) | [C](#c) | GCC | `build-essential` |
| C++ | [The Standard - C++](https://en.cppreference.com/w/cpp) | [C++](#c) | GCC/G++ | `build-essential`, `g++` |
...
| Rust | [Rust Programming Language](https://www.rust-lang.org/) | [Rust](#rust) | Rust (Crate) | `rust-lang` |
...
| ARM64 assembly | [Arm A64 Instruction Set Architecture](https://developer.arm.com/documentation/ddi0602/latest) | [ARM64 Assembly](#arm64-assembly) | GCC/GAS (AArch64) | `build-essential` |
