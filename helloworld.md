...
[![Hello World](helloworld.png)](https://github.com/rosedu/workshop-markdown/blob/solution/helloworld.png)
...
| Java | [Java Programming Language](https://www.java.com/en/) | [Java](#java) | JDK | `openjdk-17-jdk` |
...
| ARM64 assembly | [Arm A64 Instruction Set Architecture](https://developer.arm.com/documentation) | [ARM64 Assembly](#arm64-assembly) | GCC / GAS (AArch64) | `build-essential` |
