...
---      | ---                  | ---     | ---                 | ---
ARM64 assembly | [Arm A64 Instruction Set Architecture](https://www.felixcloutier.com/x86/) | [ARM64 Assembly](#ARM64-Assembly) | GCC/GAS (AArch64) | build-essential
---      | ---                  | ---     | ---                 | ---
...
---      | ---                  | ---     | ---                 | ---
PHP | [PHP: Hypertext Processor](https://www.php.net/) | [PHP](#PHP) | PHP | php
---      | ---                  | ---     | ---                 | ---
