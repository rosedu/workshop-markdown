...
| C++ | [The Standard - C++](https://isocpp.org/) | [C++](#c-1) | GCC / G++ | `build-essential`, `g++` |
...
| Java | [Java Programming Language](https://www.java.com/) | [Java](#java) | JDK | `openjdk-17-jdk` |
| x86_64 assembly | [x86 and amd64 instruction reference](https://www.felixcloutier.com/x86/) | [x86\_64 Assembly](#x86_64-assembly) | GCC / GAS | `build-essential` |
...
| Ruby | [Ruby Programming Language](https://www.ruby-lang.org/) | [Ruby](#ruby) | Ruby | `ruby` |
